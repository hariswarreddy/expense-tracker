...
export default function Navbar() {
  ...
  return (
    <nav className='sticky top-0 z-50 bg-gray-900/95 backdrop-blur-xl border-b border-gray-600/50 shadow-lg shadow-black/30'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-14 sm:h-16'>
          ...
          <div className='hidden md:flex items-center space-x-1'>
            <Link
              href='/'
              className='relative text-gray-300 hover:text-emerald-400 px-3 lg:px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-emerald-900/20 group'
            >
          ...
          <div className='flex items-center space-x-1 sm:space-x-2'>
                ...
                <div className='p-0.5 '>
                  <UserButton
                    appearance={{
                      elements: {
                        avatarBox:
                          'w-6 h-6 sm:w-8 sm:h-8 hover:scale-105 transition-transform duration-200',
            ...
            <button
              ...
              className='md:hidden p-1.5 sm:p-2 rounded-lg sm:rounded-xl text-gray-300 hover:text-emerald-400 hover:bg-emerald-900/20 transition-all duration-200 active:scale-95'
        ...
        >
          <div className='px-2 pt-2 pb-3 space-y-1 bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-600/50 mt-2 shadow-lg'>
